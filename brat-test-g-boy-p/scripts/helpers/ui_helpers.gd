...
# ===== ЦВЕТОВАЯ СХЕМА =====
const COLOR_OVERLAY = Color(0, 0, 0, 0.8)
const COLOR_BG_DARK = Color(0.05, 0.02, 0.02, 0.98)
...
# ===== СОЗДАНИЕ OVERLAY =====
static func create_overlay(alpha: float = 0.8, stop_mouse: bool = true) -> ColorRect:
