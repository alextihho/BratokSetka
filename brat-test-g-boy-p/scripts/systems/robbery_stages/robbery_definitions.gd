...
const ROBBERIES = {
	"ЛАРЁК": {
		...
		"icon": "🏪",
		"difficulty": 1,  # 1-5
		"security_level": 1,  # Уровень защиты 1-10
		"min_reward": 500,
		"max_reward": 2000,
		...
		# Требования для этапов проникновения
		"entry_requirements": {
			"lockpick": {"stat": "AGI", "min": 3, "tool": "lockpick"},  # Отмычка обязательна
			"window": {"stat": "STR", "min": 2, "tool": "melee_weapon"},  # Оружие ближнего боя
			"talk": {"stat": "CHA", "min": 4, "tool": null}  # Только навык
		}
	},
	"КВАРТИРА": {
