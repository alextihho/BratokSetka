...
# ✅ НОВОЕ: Обновление отображения времени
func update_time_display():
	...
	if date_label:
		...
		if time_sys:
			date_label.text = time_sys.get_date_time_string()
			print("⏰ DateLabel обновлен: " + date_label.text)
