...
var locations = {
	...
	"ЛАРЁК": {"position": Vector2(200, 350), "actions": ["Купить пиво (30р)", "Купить сигареты (15р)", "Купить кепку (50р)", "🛒 Черный рынок", "🎭 Ограбления"], "grid_square": "2_4"},
	"ВОКЗАЛ": {"position": Vector2(100, 150), "actions": ["Купить билет", "Встретить контакт", "Осмотреться", "🎭 Ограбления"], "grid_square": "1_1"},
	"ГАРАЖ": {"position": Vector2(550, 650), "actions": ["Купить биту (100р)", "Помочь механику", "Взять инструменты", "🎭 Ограбления"], "grid_square": "9_8"},
	"РЫНОК": {"position": Vector2(300, 850), "actions": ["Купить кожанку (200р)", "Продать вещь", "Узнать новости", "🎭 Ограбления"], "grid_square": "5_10"},
	"ПОРТ": {"position": Vector2(600, 450), "actions": ["Купить ПМ (500р)", "Купить отмычку (100р)", "🎭 Ограбления", "Уйти"], "grid_square": "10_5"},
	"УЛИЦА": {"position": Vector2(150, 1050), "actions": ["Прогуляться", "Встретить знакомого", "Посмотреть вокруг", "🎭 Ограбления"], "grid_square": "2_13"},
	...
	"АВТОСАЛОН": {"position": Vector2(250, 650), "actions": ["🚗 Выбор машины", "🔧 Починить машину", "🎭 Ограбления", "🚪 Уйти"], "grid_square": "4_8"},
	"БАНК": {"position": Vector2(450, 350), "actions": ["💰 Открыть счет", "🎭 Ограбления", "🚪 Уйти"], "grid_square": "7_4"},
	"СКЛАД": {"position": Vector2(650, 850), "actions": ["📦 Поискать товары", "🎭 Ограбления", "🚪 Уйти"], "grid_square": "10_10"}
}
