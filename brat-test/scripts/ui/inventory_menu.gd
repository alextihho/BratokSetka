...
func setup(p_data, member_index: int, p_gang_members: Array):
	...
	# Инициализация карманов если их нет
...
func create_ui():
	...
	stats_btn.position = Vector2(20, 1070)
	...
	back_btn.position = Vector2(245, 1070)
	back_btn.text = "← БАНДА"
	...
	close_btn.position = Vector2(470, 1070)
